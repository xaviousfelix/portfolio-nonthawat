        ...
        <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
          {navLinks.map((navLink) => (
            ...
            >
              <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 hover:text-white transition text-gray-500 hover:text-gray-300",
                  {
                    "text-gray-950": activeSection === navLink.title,
                  }
                )}
                href={navLink.path}
